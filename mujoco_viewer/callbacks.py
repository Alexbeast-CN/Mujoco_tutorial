...
class Callbacks:
    ...
    def _key_callback(self, window, key, scancode, action, mods):
        ...
        # Shadow Rendering
            ...
            self.user_scn.flags[mujoco.mjtRndFlag.mjRND_SHADOW] = self._shadows
        ...
        # Wireframe Rendering
            ...
            self.user_scn.flags[mujoco.mjtRndFlag.mjRND_WIREFRAME] = self._wire_frame
    ...
    def _mouse_button_callback(self, window, button, act, mods):
        ...
        if key and self.pert.select > 0:
            ...
            if newperturb and not self.pert.active:
                mujoco.mjv_initPerturb(self.model, self.data, self.user_scn, self.pert)
